...
public class ExtentListener
  ...
  public static Logger Log = LogManager.getLogger(ExtentListener.class);
  ...
  private static final Map<String, String> method = Collections.synchronizedMap(new HashMap<>());
  private static final Map<String, ExtentTest> parentTestMap =
